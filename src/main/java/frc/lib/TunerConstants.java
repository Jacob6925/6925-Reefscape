...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        ...
        using default values for angle stator current limits
        */
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.96*(2/3.0));
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.098388671875);
